...
if (obj_player1.finisher || obj_player2.finisher || (obj_player1.state == states.playersuperattack && obj_player1.superattackstate == states.transitioncutscene))
...
with (obj_baddieDead_drowned)
{
    if (visible && bbox_in_camera(view_camera[0], 32))
    {
        draw_sprite_ext_flash(sprite_index, image_index, x, y, scale, scale, angle, 13411252, 1 - scale);
        pal_swap_set(spr_palette, paletteselect, 0);
        var b = get_dark(image_blend, other.use_dark);
...
shader_reset();
draw_rectangle_color(-96, -96, -1, room_height + 96, c_black, c_black, c_black, c_black, 0);
draw_rectangle_color(room_width, -96, room_width + 96, room_height + 96, c_black, c_black, c_black, c_black, 0);
draw_rectangle_color(-96, -96, room_width + 96, -1, c_black, c_black, c_black, c_black, 0);
draw_rectangle_color(-96, room_height, room_width + 96, room_height + 96, c_black, c_black, c_black, c_black, 0);
