...
{
    if (baddieID.thrown != 1 && !other.baddieID.mach3destroy && baddieID.state != enemystates.hit && other.baddieID.thrown == true && other.baddieID.state != enemystates.hit && baddieID.killbyenemy && baddieID != other.id && baddieID.state != enemystates.grabbed && !baddieID.invincible && baddieID.instantkillable && ((global.attackstyle != 2 && !global.kungfu) || baddieID.hp <= 0) && !global.kungfu)
    {
