if (instance_exists(baddieID) && baddieID.invtime == 0 && baddieID.state != enemystates.grabbed && baddieID.state != enemystates.hit && !baddieID.invincible && baddieID.instantkillable)
{
