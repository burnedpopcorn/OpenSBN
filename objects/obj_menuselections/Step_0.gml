...
if (levelselect == 1)
{
    if (!instance_exists(obj_keyconfig))
    {
        if (input_check_pressed("down") && b < 5)
            b += 1;
    }
    
    if (input_check_pressed("up") && b > 0)
        b -= 1;
...
else if (levelselect == 0)
{
    if (!instance_exists(obj_keyconfig))
    {
        if (input_check("up") && !instance_exists(obj_keyconfig) && optionselect == 1)
            optionselect = 0;
        else if (input_check("down") && !instance_exists(obj_keyconfig) && optionselect == 0)
            optionselect = 1;
    }
    ...
    if (optionselect == 0 && input_check_pressed("jump") && !instance_exists(obj_keyconfig))
    {
        levelselect = 1;
