...
attack_pool = [states.shield, UnknownEnum.Value_177, UnknownEnum.Value_178, states.jump, UnknownEnum.Value_179, UnknownEnum.Value_181, UnknownEnum.Value_182];
...
ds_map_set(boss_hurtstates, UnknownEnum.Value_176, 30);
phase = 1;
max_phase = 7;
