...
function boss_noise_throwing()
{
    ...
    if (sprite_index == spr_null && floor(image_index) == 4 && !bombkick)
    {
        bombkick = 1;
...
function boss_noise_pogo()
{
    ...
    if (grounded && sprite_index != spr_null && sprite_index != spr_null)
    {
        image_index = 0;
        vsp = 0;
        movespeed = 0;
        pogospeedprev = 0;
        sprite_index = pogomach ? spr_null : spr_null;
        create_particle(x, y, particle.landcloud, 0);
    }
    
    if (!pogospeedprev && (sprite_index == spr_null || sprite_index == spr_null) && floor(image_index) == 4)
    {
        vsp = bombpogo ? -12 : -6;
    ...
    if (image_index > (image_number - 1) && (sprite_index == spr_null || sprite_index == spr_null || sprite_index == spr_null || sprite_index == spr_null))
        sprite_index = pogochargeactive ? spr_null : spr_null;
