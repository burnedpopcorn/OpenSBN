...
// these functions are unused LMAO
...
function scr_draw_granny_texture(x, y, xscale, yscale, tex_x, tex_y, sprite1 = smb2secret_bg, sprite2 = smb2secret_bg, bubble_sprite = spr_grannybubble)
{
	...
	draw_sprite_tiled(sprite1, 0, tex_x, tex_y);
	draw_sprite_tiled(sprite2, 0, -tex_x, -tex_y / 2);
	gpu_set_blendmode(bm_subtract);
