...
function boss_pepperman_normal()
{
    ...
    if (phase > 1 && distance_to_pos(x, y, targetplayer.x, targetplayer.y, 160, obj_gameFrame.defaultheight))
        attack_cooldown = 0;
...
function boss_pepperman_shoulderbash()
{
    ...
    if (shoulderbash_fakeout && !shoulderpound_fakeout && grounded && distance_to_pos(x, y, targetplayer.x, targetplayer.y, 180, obj_gameFrame.defaultheight))
    {
        vsp = -11;
