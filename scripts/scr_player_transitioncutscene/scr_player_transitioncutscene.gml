function state_player_transitioncutscene()
{
    ...
    if (sprite_index == spr_null && costumercutscenetimer < 0)
    {
        if (grounded && x > (other.x + 32) && x < (other.x + 160) && input_check("up") && (state == states.normal || state == states.mach1 || state == states.mach2 || state == states.mach3))
        {
