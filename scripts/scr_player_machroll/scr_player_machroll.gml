function state_player_machroll()
{
    ...
    switch (character)
    {
        case "P":
            ...
            if (!input_check("down") && !scr_solid(x + 27, y - 32) && !scr_solid(x - 27, y - 32) && !scr_solid(x, y - 32) && !scr_solid(x, y - 16))
            {
                image_index = 0;
        ...
        case "N":
            ...
            if ((!input_check("down") || !grounded) && !scr_solid(x + 27, y - 32) && !scr_solid(x - 27, y - 32) && !scr_solid(x, y - 32) && !scr_solid(x, y - 16))
            {
                image_index = 0;
                state = states.mach3;
