function scr_scareenemy()
{
    ...
    if (state != enemystates.grabbed && state != enemystates.stun && state != enemystates.hit && state != UnknownEnum.Value_268)
    {
        ...
        if (scaredbuffer > 0 && sprite_index != scaredspr && state != enemystates.stun && state != enemystates.staggered)
        {
